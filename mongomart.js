...
MongoClient.connect('mongodb://natarajgandhi:voila123@ds017582.mlab.com:17582/shoppingmart-natarajgandhi', function (err, db) {
    ...
    router.get("/member/benefits", function (req, res) {
        "use strict";
        console.log("Successfully in home page");
    ...
    router.get("/board-members", function (req, res) {
        "use strict";
        console.log("Successfully in home page");
    ...
    router.get("/home-background-flag", function (req, res) {
        "use strict";
        console.log("Successfully in home page");
